...
- issues-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- issues-ui: main application module, development time
- issues-production: module that produces a production mode WAR for deployment
