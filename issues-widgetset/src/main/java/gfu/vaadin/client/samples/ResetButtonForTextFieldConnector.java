package gfu.vaadin.client.samples;
...
import gfu.vaadin.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@gfu.vaadin.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
